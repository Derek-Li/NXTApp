...
public class TutorialPart4 extends Activity implements View.OnClickListener {
	    ...
	    new AlertDialog.Builder(this)
	        ...
	        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
	            ...
	            public void onClick(DialogInterface x, int y) {
	            	TutorialPart4.super.onBackPressed();
	            	finish();
	            }
	        }).create().show();
	}
	...
	private void nextPressed() {
		startActivity(new Intent(TutorialPart4.this, MainActivity.class));
		finish();
	}
}