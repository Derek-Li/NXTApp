...
public class TutorialPart3 extends Activity implements View.OnClickListener {
	    ...
	    new AlertDialog.Builder(this)
	        ...
	        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
	            ...
	            public void onClick(DialogInterface x, int y) {
	            	TutorialPart3.super.onBackPressed();
	            	finish();
	            }
	        }).create().show();
	}
	...
	private void nextPressed() {
		startActivity(new Intent(TutorialPart3.this, TutorialPart4.class));
		finish();
	}
}